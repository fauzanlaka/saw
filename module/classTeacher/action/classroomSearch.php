<?php
    ...
    $search = queryListInner("classroom", "WHERE classroom_name='$classroom_name' AND classroom_semester='$classroom_semester' AND classroom_year='$classroom_year' AND staff_id='$operator'", "classroom_id", "../../../connect/connect.php");
