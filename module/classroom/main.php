...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> รายการห้องเรียน</a></li>
      </ol>
</section>
            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div class="box-header">
                        <button class="btn btn-success" onclick="formLoad('module/classroom/classroomAdd.php', '', '<?= $operator ?>')"><i class="fa fa-plus"></i> เพื่มห้องเรียนใหม่</button>
                    ...
                    <div class="box-header" id="filter" style="display: none;">
                            ...
                            <form name="classroomSearch" id="classroomSearch">
                                ...
                                <div class="col-md-2">
                                    <a onclick="classroom_search('module/classroom/action/classroomSearch.php', 'classroomSearch')" class="btn btn-success" ><i class="fa fa-search"></i> ค้นหา</a>
                                </div>
                            </form>
                                ...
                                <table id="example1" class="table table-bordered table-striped table-hover table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="r<?= $classroom_id ?>">
                                            ...
                                            <td align='center'>
                                                <a onclick="formLoad('module/classroom/classroomEdit.php', '<?= $classroom_id ?>', '')" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> แก้ไข</a>
                                            </td>
                                        </tr>
                                        <?php
                                            }
