    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="alert alert-warning alert-dismissible">
                ...
                <h4><i class="icon fa fa-check"></i> ลบข้อมูลเรียบร้อยแล้ว</h4>
            </div>
        </div>
    </div>
</section>
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><i class="fa fa-dashboard"></i> เพิ่มนักเรียน</a></li>
        <li><a href="#"><i class="fa fa-dashboard"></i> <b>นักเรียนทั้งหมด</b></a></li>
      </ol>
</section>
            ...
            <div class="box box-primary">
                ...
                <div class="box-header">
                    ...
                    <div class="pull-right">
                        ...
                        <a onclick="formLoad('module/classroom/studentAdd.php', '<?= $classroom_id ?>', '<?= $operator ?>')" class="btn btn-warning"><i class="fa fa-arrow-left"></i> กลับ</a>
                    </div>
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr id="<?= $stdroom_id ?>">
                                    ...
                                    <td align="center"><a onclick="dbRowDelete('module/classroom/action/studentDelete.php', '<?= $stdroom_id ?>', '')" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i> ลบ</a></td>
                                </tr>
                                <?php
                                $i++;
                                    }
