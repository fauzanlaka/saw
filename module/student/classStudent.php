...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"> ย้ายห้อง/เลื่อนชั้น</li>
        <li><a href="#"> เพิ่ม/ลบนักเรียน</a></li>
        <li><a href="#"> <b>นักเรียนทั้งหมด</b></a></li>
      </ol>
</section>
            ...
            <div class="box box-primary">
                ...
                <div class="box-header">
                    ...
                    <div class="pull-right">
                        ...
                        <a onclick="formLoad('module/student/studentAddToClass.php', '<?= $classroom_id ?>', '<?= $operator ?>')" class="btn btn-warning"><i class="fa fa-arrow-left"></i> กลับ</a>
                    </div>
