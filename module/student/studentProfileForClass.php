...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"> ห้องเรียนทั้งหมด</a></li>
        <li><a href="#"> รายชื่อนักเรียน</a></li>
        <li><a href="#"> <b>ประวัตินักเรียน</b></a></li>
      </ol>
</section>
            ...
            <div class="box box-primary">
                ...
                <div class="box-header">
                    ...
                    <div class="pull-right">
                        ...
                        <a class="btn btn-warning" href="#" onclick="formLoad('module/student/studentClassroom.php', '<?= $classroom_id ?>', '')"><i class="fa fa-arrow-left"></i> กลับ</a> 
                    </div>
                </div>
                            ...
                            <div class="box-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td width='2%'> <b>:</b> </td>
                                        <td>
                                            <?php if($std_status=='1'){echo 'นักเรียนใหม่';} ?>
                                            <?php if($std_status=='2'){echo 'กำลังศึกษา';} ?>
                                            <?php if($std_status=='3'){echo 'สำเร็จการศึกษา';} ?>
                                            <?php if($std_status=='4'){echo 'ย้ายออก';} ?>
                                        </td>
                                    </tr>
                                    <tr>
