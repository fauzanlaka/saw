            ...
            <div class="box box-primary">
                ...
                <div class="box-header">
                    ...
                    <div class="pull-right">
                        ...
                        <a href="?mod=classroomList" class="btn btn-warning"><i class="fa fa-arrow-left"></i> กลับ</a>
                    </div>
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr id="<?= $stdroom_id ?>">
                                    ...
                                    <td align="center"><a href="#" onclick="formLoad('module/student/studentProfileForClass.php', '<?= $std_idtbl ?>', '<?= $classroom_id ?>')"><?= $std_id ?></a></td>
