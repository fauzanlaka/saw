...
window.webcam = {
	...
	swf_url: 'content/student/capture/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'content/student/capture/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : 'content/student/capture/shutter.mp3';
	},
